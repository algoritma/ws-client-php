...
echo "(`". strtolower(implode($resultStrings, "`, `")) ."`)";
echo "<br>";
...
foreach ($_arr as $i => $user) {
	if ($i==1000) break; // test için sayfayı şişirmemesi için sınır. uygulamada kaldır.
echo "\n". $i ."\n";
...
(
    [USER] => Array
        (
            [0] => Array
                (
                    [IDENTIFIER] => 5555551607
                    [ALIAS] => urn:mail:defaultpk@zorlu.com
                    [TITLE] => ZORLU CENTER SANAT MERKEZİ ANONİM ŞİRKETİ Test Kullanıcısı
                    [TYPE] => OZEL
                    [REGISTER_TIME] => 2015-11-25T16:33:46
                    [UNIT] => PK
                    [DOCUMENT_TYPE] => INVOICE
                    [ALIAS_CREATION_TIME] => 2015-11-25T16:33:46
                )

            [1] => Array
                (
                    [IDENTIFIER] => 5555552939
                    [ALIAS] => urn:mail:defaultpk@doganholding.com.tr
                    [TITLE] => DOĞAN ORGANİK ÜRÜNLER SANAYİ VE TİCARET ANONİM ŞİRKETİ Test Kullanıcısı
                    [TYPE] => OZEL
                    [REGISTER_TIME] => 2017-11-10T16:12:43
                    [UNIT] => PK
                    [DOCUMENT_TYPE] => INVOICE
                    [ALIAS_CREATION_TIME] => 2017-11-10T16:12:43
                )
          )
)
*/
